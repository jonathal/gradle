...
open class TestFixturesPlugin : Plugin<Project> {
    ...
    fun Project.configureAsProducer() {
        ...
        dependencies {
            ...
            // TODO:pm support equivalent of DynamicAddDependencyMethods in kotlin-dsl
            @Suppress("unchecked_cast")
            (listOf("jmock", "spock").map { library(it) } as List<List<Any>>).flatten().forEach {
                testFixturesCompile(it)
            }
        }
